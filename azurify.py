...
def parse_arguments():
    ...
    parser.add_argument("-s", "--sample_column_name", metavar="COLUMN_NAME", type=str, help="Specify the sample column name.")
    parser.add_argument("-l", "--litvar", action="store_true", help="Should we ping LitVar to pull publications. Takes 1 second per ping")
    parser.add_argument("-i", "--input_file", metavar="FILE_PATH", type=str, help="Specify the input file.")
    parser.add_argument("-o", "--output_directory", metavar="DIR_PATH", type=str, help="Specify the output directory.")
    parser.add_argument("-of", "--output_filename", metavar="OUTPUT_FILENAME", type=str, help="Specify the output filename.")
